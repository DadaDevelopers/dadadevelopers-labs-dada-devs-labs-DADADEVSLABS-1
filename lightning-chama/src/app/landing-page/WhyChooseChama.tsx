      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-10 space-y-4">
          ...
          <div className="flex items-start gap-4 bg-gray-50 p-4 rounded-xl border">
            <div className="w-10 h-10 rounded-lg bg-blue-100 flex justify-center items-center">
              📱
            </div>
            <div>
          ...
          {/* Community Driven */}
          <div className="flex items-start gap-4 bg-gray-50 p-4 rounded-xl border">
            <div className="w-10 h-10 rounded-lg bg-green-100 flex justify-center items-center">
              👥
            </div>
            <div>
          ...
          {/* Secure Transactions */}
          <div className="flex items-start gap-4 bg-gray-50 p-4 rounded-xl border">
            <div className="w-10 h-10 rounded-lg bg-yellow-100 flex justify-center items-center">
              🔒
            </div>
            <div>
